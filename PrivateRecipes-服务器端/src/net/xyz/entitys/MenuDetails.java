...
public class MenuDetails {
	...
	public MenuDetails(String detailsMenuImg, String detailsMenuName, String detailsMenuType,
			String detailsMenuLikeNumber, String detailsMenuMeterial, String detailsMenuSteps,
			String detailsMenuCommonts, String detailsPersonalComments) {
	...
	public String toString() {
		return "MenuDetails [detailsMenuImg=" + detailsMenuImg + ", detailsMenuName=" + detailsMenuName
				+ ", detailsMenuType=" + detailsMenuType + ", detailsMenuLikeNumber=" + detailsMenuLikeNumber
				+ ", detailsMenuMeterial=" + detailsMenuMeterial + ", detailsMenuSteps=" + detailsMenuSteps
				+ ", detailsMenuCommonts=" + detailsMenuCommonts + ", detailsPersonalComments="
				+ detailsPersonalComments + "]";
	}
